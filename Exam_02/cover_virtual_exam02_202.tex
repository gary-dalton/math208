...
\begin{center} \LARGE Math 208-202 - Exam 02\end{center}%Need to change xxx to a number
\smallskip

\begin{center} \begin{tabular}{l l}
		\textbf{Date}: 3/18/2021  & \\
		\textbf{Time}: 6:40pm to 7:40pm &
		\textbf{Submission deadline}: 8:10pm\\
...
\begin{enumerate}
	\item Login and remain logged into your Collaborate Ultra virtual session. Your camera must remain on for the duration of the exam. You may be asked to show your ID or scan the room with your camera.
